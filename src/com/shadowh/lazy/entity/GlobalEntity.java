...
import com.shadowh.lazy.util.XmlUtil;
...
public class GlobalEntity {
	...
	public static GlobalEntity parseXml(Element rootElement){
		...
		Map<String, Object> propertyMap = XmlUtil.elementToMap(propertyElement);
		if (propertyMap != null) {
			globalEntity.setAuthor(MapUtils.getString(propertyMap, "author"));
		}

		Element entityElement = rootElement.element("entity");
		Map<String, Object> entityMap = XmlUtil.elementToMap(entityElement);
		if (entityMap != null) {
		...
		Map<String, Object> mapperMap = XmlUtil.elementToMap(mapperElement);
		if (mapperMap != null) {
		...
		Map<String, Object> mapperXmlMap = XmlUtil.elementToMap(mapperXmlElement);
		...
		Map<String, Object> serviceMap = XmlUtil.elementToMap(serviceElement);
		if (serviceMap != null) {
		...
		Map<String, Object> serviceImplMap = XmlUtil.elementToMap(serviceImplElement);
		...
		Map<String, Object> controllerMap = XmlUtil.elementToMap(controllerElement);
