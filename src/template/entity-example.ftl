...
public class ${table.moduleNameCapi}Example{
	...
	public class Criteria {
	  ...
	  <#list table.fields as key> 
		...
		public Criteria and${key.field?cap_first}EqualTo(${key.fieldType} value) {
			addCriterion("${key.column} =",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}
		
		public Criteria and${key.field?cap_first}NotEqualTo(${key.fieldType} value) {
			addCriterion("${key.column} <>",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}GreaterThan(${key.fieldType} value) {
			addCriterion("${key.column} >",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}GreaterThanOrEqualTo(${key.fieldType} value) {
			addCriterion("${key.column} >=",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}LessThan(${key.fieldType} value) {
			addCriterion("${key.column} <",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}LessThanOrEqualTo(${key.fieldType} value) {
			addCriterion("${key.column} <=",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}
		
		
		public Criteria and${key.field?cap_first}EqualToField(${key.fieldType} fieldName) {
			addCriterion("${key.column} =",Criterion.fieldValue, fieldName, "${key.field}");
			return (Criteria) this;
		}
		
		public Criteria and${key.field?cap_first}NotEqualToField(${key.fieldType} fieldName) {
			addCriterion("${key.column} <>",Criterion.fieldValue, fieldName, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}GreaterThanField(${key.fieldType} fieldName) {
			addCriterion("${key.column} >",Criterion.fieldValue, fieldName, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}GreaterThanOrEqualToField(${key.fieldType} fieldName) {
			addCriterion("${key.column} >=",Criterion.fieldValue, fieldName, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}LessThanField(${key.fieldType} fieldName) {
			addCriterion("${key.column} <",Criterion.fieldValue, fieldName, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}LessThanOrEqualToField(${key.fieldType} fieldName) {
			addCriterion("${key.column} <=",Criterion.fieldValue, fieldName, "${key.field}");
			return (Criteria) this;
		}
		

		public Criteria and${key.field?cap_first}Like(${key.fieldType} value) {
			addCriterion("${key.column} like",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}NotLike(${key.fieldType} value) {
			addCriterion("${key.column} not like",Criterion.singleValue, value, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}In(List<${key.fieldType}> values) {
			addCriterion("${key.column} in",Criterion.listValue, values, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}NotIn(List<${key.fieldType}> values) {
			addCriterion("${key.column} not in",Criterion.listValue, values, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}Between(${key.fieldType} firstValue, ${key.fieldType} secondValue) {
			addCriterion("${key.column} between", Criterion.betweenValue,firstValue, secondValue, "${key.field}");
			return (Criteria) this;
		}

		public Criteria and${key.field?cap_first}NotBetween(${key.fieldType} firstValue, ${key.fieldType} secondValue) {
